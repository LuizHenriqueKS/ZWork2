 ...
 */
public class ZStringSearchTest3 extends ZSimpleTest<List<Integer>> {
    ...
    public List<Integer> getResult() {
        ...
        ZStringSearch search = new ZStringSearch(SOURCE, true,patterns,patternsToVoid, ZStringSearchType.COMULATIVE);

 ...
 */
public class ZFileTests extends ZMultipleTests {

    @Override
    public void loadListTests(List<ZCustomTest> listTests) {
        
        //OBTEM O PACOTE DA ZInjectTest1
        ZPackage pack = new ZPackage(getClass(),ZFileTest1.class.getPackage()); //AQUI É ESTÃO ESTÁ TODOS OS TESTES DE INJEÇÕES

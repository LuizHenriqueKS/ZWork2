...
import br.zul.zwork2.test.basic.string.search.ZStringSearchTest1;
 ...
 */
public class ZStringSearchTests extends ZMultipleTests {

    @Override
    public void loadListTests(List<ZCustomTest> listTests) {
        
        //OBTEM O PACOTE DA ZHttpTest1
        ZPackage pack = new ZPackage(getClass(),ZStringSearchTest1.class.getPackage()); //AQUI É ONDE ESTÃO TODOS OS TESTES DE PESQUISA DE TEXTO
    ...
    public String getTestName() {
        return "funções para pesquisa de texto";
    }
